...
{{#ifcond downloadlink "==" "yes" }}
       <tr>
         <td valign="top">
           <b>Download ZIP</b>
         </td>
         <td>
           <a href="../{{zipfilename}}.zip" target="_blank">Presentation as ZIP</a>
         </td>
       </tr>
{{/ifcond}}
        <tr>
...
<script>
  ...
  Dz.onkeydown = function(aEvent) {
    ...
    document.location.href = "slide{{{first}}}.html";
  ...
  Dz.goFirstSlide = function() {
    window.document.location.href = "slide0.html";
  }
...
<!-- vim: set fdm=marker: -->
<button class="iconnext" onclick="document.location.href='slide{{{first}}}.html'">&nbsp; &gt; START &gt; &nbsp;</button>
<button class="iconprevious" onclick="Dz.back()" style="display:none">&nbsp; &lt; &nbsp;</button>
</body>
</html>
