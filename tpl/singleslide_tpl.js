...
<head>
  ...
  <!--
       =============================================
       Slide {{{slideindex}}}
       Image images/{{data.image.basename}}{{current.number}}.{{data.image.ext}}
...
<body>
<section id="section{{slideindex}}" class="slide level2"  style="background: black">
	<table>
		<tr>
			<td>
				<center>
{{#ifcond current.audio.ext "!=" "-"}}
					{{{data.audio.controls}}}
			  		<source src="audio/{{current.audio.name}}"  loading="lazy" type="audio/{{current.audio.audiotype}}">
            <!-- AudioType: {{current.audio.audiotype}} -->
					</audio>
{{/ifcond}}
{{#ifcond current.audio.ext "==" "-"}}
...
{{/ifcond}}
		...
		<tr>
			<td>
				<center>
					<img src="images/{{current.image.name}}"  loading="lazy"  width="90%" title="Slide {{{slideindex}}} with Audioplayer " />
          <!-- ImageType: {{current.image.imgtype}} -->
  		</center>
			</td>
		</tr>
	</table>
